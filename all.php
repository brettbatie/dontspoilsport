...
<div id="dialog-modal" title="Demo is Over">
  <p>Sorry, this page used to display some great stats (scores, standings, news, etc) pulled straight from ESPN and <a href="http://sportsdatallc.org/">Sports Data</a>. The API key was intended for a temporary demo where we offered an alternate view of the sports news while not displaying sports info for select teams. This allowed a user to catch up on the latest news while not worrying about the game they missed/recorded for later viewing. The code is still fully functional but requires a subscription to the Sports Data API.</p>
</div>
<div class="scores">
